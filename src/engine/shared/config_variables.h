...
MACRO_CONFIG_INT(GfxAnimateWater, gfx_animate_water, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0=use static animation 1=dynamic water")
MACRO_CONFIG_INT(GfxWaterOutline, gfx_wateroutline, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0=no outline 1=outline")
MACRO_CONFIG_INT(GfxWaterYmultiplier, gfx_waterYmultiplier, 75, 0, 1000000, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Debug")
MACRO_CONFIG_INT(GfxWaterXmultiplier, gfx_waterXmultiplier, 75, 0, 1000000, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Debug")
MACRO_CONFIG_INT(GfxWatergravity, gfx_watergravity, 750, -10000, 1000000, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Debug")
