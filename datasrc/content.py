...
image_water = Image("water", "mapres/water.png", 1)
image_rope = Image("rope", "rope.png", 1)
...
container.images.Add(image_water)
container.images.Add(image_rope)
...
container.pickups.Add(Pickup("diving_gear"))
container.pickups.Add(Pickup("harpoon"))
...
set_water = SpriteSet("water", image_water, 4, 16)
set_rope = SpriteSet("rope", image_rope, 2, 1)
...
container.spritesets.Add(set_water)
container.spritesets.Add(set_rope)
...
container.sprites.Add(Sprite("rope_mid", set_rope, 0,0,1,1))
container.sprites.Add(Sprite("rope_end", set_rope, 1,0,1,1))
...
container.sprites.Add(Sprite("part_droplet", set_particles, 6,2,1,1))
...
container.sprites.Add(Sprite("weapon_harpoon_body", set_game, 20,12,8,3))
container.sprites.Add(Sprite("weapon_harpoon_proj", set_game, 28,12,4,3))
container.sprites.Add(Sprite("weapon_harpoon_cursor", set_game, 0,14,2,2))
...
container.sprites.Add(Sprite("pickup_harpoon", set_game, 20,12,8,3))
...
container.sprites.Add(Sprite("tee_diving_gear", set_diving_gear, 1,1,6,6))
...
container.sprites.Add(Sprite("diving_bar_empty_right", set_game, 24,8,1,2))
container.sprites.Add(Sprite("part_bubble0", set_particles, 5,0,1,1))
container.sprites.Add(Sprite("part_bubble1", set_particles, 6,0,1,1))
...
container.sprites.Add(Sprite("water02", set_water, 0,2,1,1))
container.sprites.Add(Sprite("water03", set_water, 0,3,1,1))
container.sprites.Add(Sprite("water04", set_water, 0,4,1,1))
container.sprites.Add(Sprite("water05", set_water, 0,5,1,1))
container.sprites.Add(Sprite("water06", set_water, 0,6,1,1))
container.sprites.Add(Sprite("water07", set_water, 0,7,1,1))
container.sprites.Add(Sprite("water08", set_water, 0,8,1,1))
container.sprites.Add(Sprite("water09", set_water, 0,9,1,1))
container.sprites.Add(Sprite("water0A", set_water, 0,10,1,1))
container.sprites.Add(Sprite("water0B", set_water, 0,11,1,1))
container.sprites.Add(Sprite("water0C", set_water, 0,12,1,1))
container.sprites.Add(Sprite("water0D", set_water, 0,13,1,1))
container.sprites.Add(Sprite("water0E", set_water, 0,14,1,1))
container.sprites.Add(Sprite("water0F", set_water, 0,15,1,1))

container.sprites.Add(Sprite("water10", set_water, 1,0,1,1))
container.sprites.Add(Sprite("water11", set_water, 1,1,1,1))
container.sprites.Add(Sprite("water12", set_water, 1,2,1,1))
container.sprites.Add(Sprite("water13", set_water, 1,3,1,1))
container.sprites.Add(Sprite("water14", set_water, 1,4,1,1))
container.sprites.Add(Sprite("water15", set_water, 1,5,1,1))
container.sprites.Add(Sprite("water16", set_water, 1,6,1,1))
container.sprites.Add(Sprite("water17", set_water, 1,7,1,1))
container.sprites.Add(Sprite("water18", set_water, 1,8,1,1))
container.sprites.Add(Sprite("water19", set_water, 1,9,1,1))
container.sprites.Add(Sprite("water1A", set_water, 1,10,1,1))
container.sprites.Add(Sprite("water1B", set_water, 1,11,1,1))
container.sprites.Add(Sprite("water1C", set_water, 1,12,1,1))
...
anim = Animation("swim")
anim.back_foot.frames.Add(AnimKeyframe(0.0, 0-3, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.25, -4-3, 1, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.5,0-7,0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.75, 4-3,-1, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(1.0, -3, 0, -0.1))

anim.front_foot.frames.Add(AnimKeyframe(0.0, 4+3,-1, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.25, 0+3,0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.5, -4+3,1,-0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.75, 0+3, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(1.0,4+3,-1, -0.1))
container.animations.Add(anim)
